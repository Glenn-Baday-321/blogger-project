...
<body>
    ...
    <nav class="flex flex-row border w-3/4 m-auto p-3">
        ...
        <div class="flex flex-row w-full justify-center basis-3/4 border">
            <div class="border mx-3"><a href="" class="bg-purple-500 px-3 py-1 rounded-sm">Item 1</a></div>
            <div class="border mx-3"><a href="" class="bg-purple-500 px-3 py-1 rounded-sm">Item 1</a></div>
            <div class="border mx-3"><a href="" class="bg-purple-500 px-3 py-1 rounded-sm">Item 1</a></div>
        </div>
        <div class="flex flex-row w-full justify-center basis-1/2 border">
            <div class="mx-3 border"><a href="/login" class="bg-purple-500 px-3 py-1 rounded-sm">Login</a></div>
            <div class="px-3 mx-3 border"><a href="" class="bg-purple-500 text-white font-bold py-2 px-4 rounded-full">Sign-up</a></div>
        </div>
    </nav>
    <!-- Navigation end -->
    <!-- Hero section -->
    <div class="h-[90vh] flex flex-row justify-center w-11/12 m-auto">
        <div class="border flex flex-col w-full items-center justify-center  bg-hero-img bg-cover rounded-lg drop-shadow-sm">
    ...
    <!-- Articles -->
        <section class="grid grid-rows-2 grid-flow-col gap-7 w-11/12 m-auto my-10">
            <div class="row-span-3 border rounded-lg shadow-lg">
                <div class="">
                    <img class="rounded-lg" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/681px-Placeholder_view_vector.svg.png" alt="image">
                    <div class="">
    ...
    <section class="flex flex-col w-3/4 m-auto items-center my-10">
        ...
        <button class="bg-purple-500 text-white font-bold py-2 px-4 rounded-full">Start Blogging</button>
    </section>
    <!-- call to action end -->
